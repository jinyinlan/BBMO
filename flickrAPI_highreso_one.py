...
if __name__ == '__main__':
	...
	with open('/home/omiya/data/test-set0811/small-val/validation_set2.txt', 'r') as f:
		file_name = f.readlines()

	for f in file_name:
		photo_date = f[:10]
		photo_id = f[11:22]
		print(photo_date, photo_id)

		f = Flickr(api_key)

		photo_url = f.get_url_from_photo_id(photo_id)
		...
		if (photo_url):
			download_image(photo_url, photo_id, photo_date)
		else:
			print(photo_id, ': url is None')
