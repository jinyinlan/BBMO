...
original_image_dir = '/home/omiya/data/Flickr_Interestingness_test/'+date+'/'
bad_image_dir = '/home/omiya/data/Flickr_Interestingness_test/degraded_photos/temp/'

f = open('/home/omiya/data/Flickr_Interestingness_test/'+date+'/all_file_name.txt', 'r')
