...
def encode_f2b(paramfile_name, XMPdataFile_name):
	...
	for input_string in f:
		...
		if input_string.split(' ')[0]=='exposure':
			...
			exposure = '00000000'+binaryParam_black+binaryParam_exposure+'00004842000080c0' #python2
			#exposure = '00000000'+str(binaryParam_black).split("\'")[1]+str(binaryParam_exposure).split("\'")[1]+'00004842000080c0' #python3
		...
		if input_string.split(' ')[0]=='shadhi':
			...
			shadhi = '000000000000c842'+binaryParam_shadow+binaryParam_whitepoint+binaryParam_highlight+'0000000000004842'+binaryParam_shadowSat+binaryParam_highlightSat+'7f000000bd37863500000000' #python2
			#shadhi = '000000000000c842'+str(binaryParam_shadow).split("\'")[1]+str(binaryParam_whitepoint).split("\'")[1]+str(binaryParam_highlight).split("\'")[1]+'0000000000004842'+str(binaryParam_shadowSat).split("\'")[1]+str(binaryParam_highlightSat).split("\'")[1]+'7f000000bd37863500000000' #python3
		...
		if input_string.split(' ')[0]=='colisa':
			...
			#colisa = str(binaryParam_contrast).split("\'")[1]+str(binaryParam_light).split("\'")[1]+str(binaryParam_saturation).split("\'")[1]
		...
		if input_string.split(' ')[0]=='temperature':
			...
			#temperature = '00409c45'+str(binaryParam_red).split("\'")[1]+str(binaryParam_green).split("\'")[1]+str(binaryParam_blue).split("\'")[1]
		...
		if input_string.split(' ')[0]=='vibrance':
			...
			#vibrance = str(binaryParam_vibrance).split("\'")[1]
		...
		if input_string.split(' ')[0]=='colorcorrection':
			...
			#colorcorrection = str(binaryParam_highX).split("\'")[1]+str(binaryParam_highY).split("\'")[1]+str(binaryParam_shadX).split("\'")[1]+str(binaryParam_shadY).split("\'")[1]+str(binaryParam_ccSat).split("\'")[1]
		...
		if input_string.split(' ')[0]=='colorcontrast':
			...
			#colorcontrast = str(binaryParam_GM).split("\'")[1]+'00000000'+str(binaryParam_BY).split("\'")[1]+'0000000001000000'
