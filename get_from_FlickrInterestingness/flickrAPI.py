...
def download_image(photo_url, photo_id, photo_date):
	savedir = '/home/omiya/data/Flickr_Interestingness_test/'+photo_date+'/'
	if not os.path.exists(savedir):
		os.mkdir(savedir)
...
if __name__ == '__main__':
	...
	with open( '/home/omiya/data/Flickr_Interestingness_test/'+photo_date+'/all_file_name.txt', 'w' ) as file:
